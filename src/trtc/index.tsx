...
export default function Trtc() {
  const [meetId, setMeetId] = React.useState('6868')
  const [userId, setUserId] = React.useState('123123')
  ...
  function onRtcListener(type: string, params: any) {
    // console.log('==onRtcListener', type, params)
    ...
    if (type === TRTCCloudListener.onUserSubStreamAvailable) {
      console.log('onUserSubStreamAvailable',type, params)
        ...
        <View style={styles.fixToText}>
          <Button
            ...
            onPress={async () => {
              ...
              trtcCloud.startLocalAudio(TRTCCloudDef.TRTC_APP_SCENE_VIDEOCALL)
            }}
          />
          <Button
            title="Share Screen"
