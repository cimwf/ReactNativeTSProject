...
const HomeScreen = (props) => {
    ...
    const onRouteTo = (id: String, name: String) => {
        props.navigation.navigate('IMDetailsScreen', { idStr: id, nameStr: name })
    };
                ...
                [
                    {
                        text:'OK',
                        onPress:()=>{
                            props.navigation.navigate('IMUserScreen')
                        }
                    }
                ]
            ) 
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity
          style={{ width: '100%', height: 50, backgroundColor: 'yellow', justifyContent: 'center', alignItems: 'center'}}
          onPress={() => props.navigation.navigate('IMUserScreen')}
        >
          <Text>User</Text>
        </TouchableOpacity>
        <SectionList
